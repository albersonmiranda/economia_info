...
```{r receitas de filmes, fig.align = "center", fig.cap = "Ingressos vendidos e receita do conema nos Estados Unidos em US\\$ \\citep{filmes}", out.width = '70%'}
...
```{r receitas de games, fig.align = "center", fig.cap = "Proporção das vendas de jogos eletrônicos por mídia \\citep{games}", out.width = '70%'}

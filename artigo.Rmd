...
Essa exacerbação do *star-system* traz ao seu lado uma ameaça ao próprio modelo. O aumento da participação do capital no processo de produção artístico, que nesse caso se traduz na redução da diferenciação, ou seja, da heterogeneidade da indústria, reduz a participação dos elementos que produzem o valor simbólico aleatório, que acabam por eventualmente reduzir as próprias receitas do setor. A título de exemplo, o gênero de filmes de super-heróis, objeto da oligopolização da indústria cinematográfica na última década, que já não conta com a legitimização do setor de produção erudito, também começa a perder seu ímpeto dentre os consumidores --- em um ano, o número de pessoas nos EUA que relataram estarem cansados de filmes desse gênero subiu 6 p.p. \citep{shevenock}. 

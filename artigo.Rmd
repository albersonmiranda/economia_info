...
```{r receitas da musica, fig.align = "center", fig.cap = "Receita global da indústria da música em US\\$ bi \\citep{commons}", out.width = '50%'}
...
```{r receitas de filmes, fig.align = "center", fig.cap = "Ingressos vendidos e receita do conema nos Estados Unidos em US\\$ \\citep{numbers}", out.width = '50%'}
...
```{r receitas de games, fig.align = "center", fig.cap = "Proporção das vendas de jogos eletrônicos por mídia \\citep{statista}", out.width = '50%'}
...
```{r oligo musica, fig.align = "center", fig.cap = "Quantidade de artistas diferentes compondo a Billboard 100 por ano \\citep{experimentalhistory}", out.width = '50%'}
...
```{r oligo filmes, fig.align = "center", fig.cap = "Filmes no \\textit{top} 20 de \\textit{box office} que são prequelas, sequências, \\textit{spinoffs}, \\textit{remakes}, \\textit{reboots} ou universo cinemático expandido \\citep{experimentalhistory}", out.width = '50%'}
knitr::include_graphics("img/oligo-filmes.png")
```

```{r oligo tv, fig.align = "center", fig.cap = "Programas de TV dentre os 30 de maior audiência que são \\textit{spinoffs}ou são exibidos em mais de um dia na semana \\citep{experimentalhistory}", out.width = '50%'}
...
```{r oligo livros, fig.align = "center", fig.cap = "Proporção de livros entre os mais 10 vendidos no ano por autores com mais de um livro no \\textit{top} 10 \\citep{experimentalhistory}", out.width = '50%'}
